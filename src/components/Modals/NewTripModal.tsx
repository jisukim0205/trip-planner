...
export default function NewTripModal({ onClose }: NewTripModalProps) {
  const { addTrip, setCurrentTrip, setCurrentWeekStart } = useTripStore();
  ...
  const [gridEndHour, setGridEndHour] = useState(23);
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-6 max-h-[90vh] overflow-y-auto">
        <h2 className="text-xl font-bold text-gray-800 mb-5">New Trip</h2>
